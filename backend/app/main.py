...
def api_get_profile_config(profile_id: str, active_profile_id: Optional[str] = Cookie(None)):
    ...
    return {
        ...
        "gcp_project_id": settings_data.get("gcp_project_id", ""),
        ...
        "spotify_client_secret_configured": bool(settings_data.get("spotify_client_secret")),
        "spotify_redirect_uri": settings_data.get("spotify_redirect_uri", ""),
        "active_task_lists": settings_data.get("active_task_lists", ["@default"]),
        "google_sa_configured": os.path.exists(os.path.join(settings.TOKENS_DIR, "profiles", profile_id, "service_account.json"))
    }
